...
class HomeController extends AbstractController
{
    ...
    public function index(Request $request)
    {
        ...
        $skills[] = array('border'=>'#86befb', 'img'=>'images/ps.jpg', 'name'=>'ADOBE<br>PHOTOSHOP', 'alt'=>'adobe photoshop');
        $skills[] = array('border'=>'#FF7B00', 'img'=>'images/ai.jpg', 'name'=>'ADOBE<br>ILLUSTRATOR', 'alt'=>'adobe illustrator');
 		$skills[] = array('border'=>'#ff58a0', 'img'=>'images/id.jpg', 'name'=>'ADOBE<br>INDESIGN', 'alt'=>'photo manipulation');
 		$skills[] = array('border'=>'#d473f8', 'img'=>'images/pr.jpg', 'name'=>'ADOBE<br>PREMIERE', 'alt'=>'photo manipulation');
 		$skills[] = array('border'=>'#101152', 'img'=>'images/c4d.png', 'name'=>'CINEMA<br>4D', 'alt'=>'photo manipulation');
 		$skills[] = array('border'=>'#84cd62', 'img'=>'images/paint.png', 'name'=>'MICROSOFT<br>PAINT', 'alt'=>'photo manipulation');
 		$skills[] = array('border'=>'#2f0300', 'img'=>'images/joomla.png', 'name'=>'JOOMLA<br>&nbsp;', 'alt'=>'photo manipulation');
        $skills[] = array('border'=>'#40871d', 'img'=>'images/android.png', 'name'=>'ANDROID<br>&nbsp;', 'alt'=>'photo manipulation');
        $skills[] = array('border'=>'#E9E9E9', 'img'=>'images/jquery.png', 'name'=>'JQUERY<br>&nbsp;', 'alt'=>'photo manipulation');
        $skills[] = array('border'=>'#6E5400', 'img'=>'images/js.png', 'name'=>'JAVASCRIPT<br>&nbsp;', 'alt'=>'photo manipulation');
        $skills[] = array('border'=>'#791900', 'img'=>'images/html5.png', 'name'=>'HTML5<br>&nbsp;', 'alt'=>'photo manipulation');
        $skills[] = array('border'=>'#014574', 'img'=>'images/html3.png', 'name'=>'CSS3<br>&nbsp;', 'alt'=>'photo manipulation');
		$skills[] = array('border'=>'#FFE4B7', 'img'=>'images/mysql.png', 'name'=>'MYSQL<br>&nbsp;', 'alt'=>'photo manipulation');
		$skills[] = array('border'=>'#000000', 'img'=>'images/sf.png', 'name'=>'SYMFONY<br>&nbsp;', 'alt'=>'photo manipulation');
		$skills[] = array('border'=>'#EAFFB4', 'img'=>'images/twig.jpg', 'name'=>'TWIG<br>&nbsp;', 'alt'=>'photo manipulation');
		$skills[] = array('border'=>'#222430', 'img'=>'images/php.jpg', 'name'=>'PHP<br>&nbsp;', 'alt'=>'photo manipulation');
    ...
    public function email(Request $request, \Swift_Mailer $mailer){
        ...
        $transport = (new \Swift_SmtpTransport('mail.darioviegas.com', 465, 'ssl'))
            ...
            $message->getHeaders()->addTextHeader('List-Unsubscribe', 'http://darioviegas.com'); 
